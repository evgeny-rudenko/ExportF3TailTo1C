...
SELECT
    ...
    NDS_RATE = CASE WHEN 1  = 1 THEN CAST(L.VAT_SUP AS DECIMAL(18,4)) ELSE NULL END,
    NDS_RATE_R =CASE WHEN 1 = 1 THEN CAST(L.VAT_SAL AS DECIMAL(18,4)) ELSE NULL END,
...
WHERE 1=1
    ...
    CASE WHEN @STORE_GROUP = 1 THEN L.STORE_NM ELSE NULL END,
        ...
        CASE WHEN 1 = 1 THEN CAST(L.VAT_SUP AS DECIMAL(18,4)) ELSE NULL END,
	    CASE WHEN 1 = 1 THEN CAST(L.VAT_SAL AS DECIMAL(18,4)) ELSE NULL END,

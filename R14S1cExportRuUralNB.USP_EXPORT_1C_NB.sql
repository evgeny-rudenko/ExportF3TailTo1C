...
SELECT
	...
	TYPE_PAY =  CAST(NULL AS VARCHAR(5)),  -- ‚ÂÓˇÚÌÂÂ ‚ÒÂ„Ó Ì‡Î ·ÂÁÌ‡Î 
	...
	CORRECT_SF_TYPE =  CAST(NULL AS INT),
	QUANTITY = CAST(SUM(CASE WHEN CH.CHEQUE_TYPE_char = 'RETURN' THEN 0 ELSE 1 END * CP.QUANTITY) AS DECIMAL(18,2)),
